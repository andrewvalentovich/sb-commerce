            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <dropdown v-if="auth.user">
                    ...
                    <template #content>
                        <ul class="py-2">
                            <li>
                                <NuxtLink v-if="auth.checkAdmin" :to="{name: 'admin-panel'}" class="w-full text-left block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Панель администратора</NuxtLink>
                            </li>
                            <li>
