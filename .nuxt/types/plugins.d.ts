...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/pinia-plugin-persistedstate/dist/nuxt/runtime/plugin.js").default> &
  ...
  InjectionType<typeof import("../../client/plugins/authPlugin").default> &
  InjectionType<typeof import("../../client/plugins/clickOutsidePlugin").default> &
  InjectionType<typeof import("../../client/plugins/outsidePlugin").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:head' | 'nuxt:router' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'nuxt:checkIfLayoutUsed'
  }
}
